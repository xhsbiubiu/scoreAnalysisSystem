...
import com.fwwb.scoreAnalysis.common.util.StringUtils;
 ...
 *
 *  利用拦截器实现Mybatis分页的原理：
 *       要利用JDBC对数据库进行操作就必须要有一个对应的Statement对象                       JDBC  -> Statement
 * ，    Mybatis在执行Sql语句前就会产生一个包含Sql语句的Statement对象，而且对应的Sql语句        before statement is sql
 *      是在Statement之前产生的，所以我们就可以在它生成Statement之前对用来生成Statement的Sql语句下手   deal with sql
 * 。
 *          在Mybatis中Statement语句是通过RoutingStatementHandler对象的prepare方法生成的。  RoutingStatementHandler.prepare -> Statement
...
public class PageInterceptor implements Interceptor {
    ...
    private String getPageSql(Page page, String sql) {
        ...
        if (StringUtils.isNotEmpty(page.getSort())) {
            ...
            sqlBuffer.append(page.getSort()).append(" ");
        }
    ...
    private String getOraclePageSql(Page page, StringBuffer sqlBuffer) {
        ...
        int offset = page.getNumber() * page.getSize() + 1;
     ...
     */
    private void setTotalRecord(Page page, Object obj, MappedStatement mappedStatement,
        ...
        public static Object getFieldValue(Object obj, String fieldName) {
            ...
            if (field != null) {
                ...
                try {
                    ...
                    log.error("反射获取对象参数不正确", e);
                } catch (IllegalAccessException e) {
                    log.error("反射访问参数出错", e);
                }
            }
            return result;
        }
